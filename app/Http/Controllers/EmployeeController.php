...
//			Session::flash('Success', 'you must have at least 1 role created before attempting to create an employee');
			return redirect()->back()->with('info', 'You must have at least 1 role created before attempting to create an employee');
		}
...
//		Session::flash('success', 'The employee user account is restored.');
		return redirect()->route('employees.index')->with('success', 'The employee account is restored.');
	}
	...
	public function kill($id){
		...
		return redirect()->route('employees.index')->with('success', 'The employee account has been permanently destroyed.');
	}
}
